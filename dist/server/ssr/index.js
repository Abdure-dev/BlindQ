...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-g_xbg_h0.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-CrL44Ynz.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-pM0ApMVX.js");
		return { get "default"() {
			return m["default"];
		} };
	},
