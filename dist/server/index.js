...
function getDraftSecret() {
	return "14bac2b6-aa1a-4ed3-8765-ff7e96987fd6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7f2966d0-faa4-4b38-9cfd-216cd0b2f11a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7f2966d0-faa4-4b38-9cfd-216cd0b2f11a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7f2966d0-faa4-4b38-9cfd-216cd0b2f11a",
		rootBoundaryId
	});
}
/**
