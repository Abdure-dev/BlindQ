globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-C-r4Yxti.js","assets/layout-segment-context-40yz9q9C.js"];
...
function getDraftSecret() {
	return "89b71526-2b25-49bb-95ec-afc9e4929827";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7318ffe2-e7b5-4724-b400-62508afa456f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7318ffe2-e7b5-4724-b400-62508afa456f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7318ffe2-e7b5-4724-b400-62508afa456f",
		rootBoundaryId
	});
}
/**
...
var title = "BlindQ — Private Quantum Cloud";
var description = "Delegate quantum computation without revealing the algorithm, input, or result.";
async function generateMetadata() {
	const requestHeaders = await headers();
	const host = requestHeaders.get("x-forwarded-host") ?? requestHeaders.get("host") ?? "localhost:3000";
	const ogImage = `${requestHeaders.get("x-forwarded-proto") ?? (host.startsWith("localhost") ? "http" : "https")}://${host}/og.png`;
	return {
		title,
		description,
		openGraph: {
			...
			images: [{
				...
				width: 1792,
				height: 933,
				alt: "BlindQ — Compute here. Reveal nothing."
			}]
		},
		twitter: {
